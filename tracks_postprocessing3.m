function [TRACKS, EXIT_STRUCT, POKE_STRUCT] = tracks_postprocessing3( allTracks, ev_ho_dict, bg_struct, pixpermm )
...
for i = 1:length(allTracks)
    ...
    [omega, head, tail, head_gs, tail_gs] = head_and_tail_kalman2(TRACKS(i));
    TRACKS(i).head = head;
    TRACKS(i).tail = tail;
