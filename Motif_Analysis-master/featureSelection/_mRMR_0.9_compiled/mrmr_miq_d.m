...
%
% Inputs:
% Three arrays, d, f, and K. d is an m*n array of your candidate features,
% each row is a sample, and each column is a feature/attribute/variable. f 
% is an m*1 vector, specifying the classification variable (i.e. the class 
% information for each of the m samples). K is the maximal number of features
% you want to select.
 
% D must be pre-discretized as a categorical array, i.e. containing only 
% integers. F must be categorical, indicating the class information.
