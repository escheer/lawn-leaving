function tracking_enter_exit_BATCH_122417(loadconfig, getpixels)
clc; close all;
warnid = 'images:initSize:adjustingMag';
warning('off',warnid);

lawn_string = 'dec24_2017_BATCH';
...
for vid = 1:length(batch_struct)
    ...
    save([videoname '_' lawn_string '_SLIM' '.mat'],'TRACKS_slim','EXIT_STRUCT','POKE_STRUCT','bg_struct');
    save([videoname '_' lawn_string '.mat'],'TRACKS','-v7.3');
