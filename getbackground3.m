function [orig_background, clean_background, filledbg2, level, abovethresh] = getbackground3( v, outer_boundary_mask, outer_boundary_line, level, firstvideo, old_abovethresh, lawn_limit_mask)
...
clean_background = imgaussfilt(filledbg2,10);%blur out any fine features of the background with a radius much larger than the worm
