...
function [tracks, nextId] = createNewTracks_wholevideo(tracks,nextId,x_shift,y_shift,unassignedDetections,centroids,bboxes,cropworms,cropworms_orig,splines,end1s, end2s, end1s_g, end2s_g, worms,curvatures, posture_angles, curr_frame,videoframe,videoname)
...
worms = worms(unassignedDetections);
