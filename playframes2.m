function playframes2( track, bg_struct, indices, coherence_thresh, speed_thresh, behavFLAG, deployable )
...
[~, cent_vector, ~, ~, ~, ~, ~] = getforwardreverse2( track.centroid,track.head,track.tail,track.speed, coherence_thresh, speed_thresh );
