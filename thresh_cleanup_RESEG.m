function BWfinal = thresh_cleanup_RESEG( binImg )
...
%     BWnobord = imclearborder(BWdfill, 4); don't use this for pre-cut worm
%     images in the resegmenting code
    se = strel('disk',1);
    BWerode = imerode(BWdfill,se); %erode once
