function [omega, head, tail, head_gs, tail_gs] = head_and_tail_kalman2( WORMTRACK )
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% NESTED FUNCTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function [assignments, unassignedTracks, unassignedDetections] = ...
        ...
        if ~isempty(k2) %remove centroid detections that result in a minimum displacement of X
%             centroids(k2,:) = [];
            centroids = [];
        end
