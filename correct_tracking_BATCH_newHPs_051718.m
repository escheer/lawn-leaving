function correct_tracking_BATCH_newHPs_051718(NUMWORMS, startmin, endmin, out_dir)
clc; close all;
...
for i = 1:length(trklist)
    ...
    try
        ...
        error('need a bg_struct to run this correction!');
    end
...
%     end
    ...
    expression = 'FINAL';
    idx_FINAL = regexp(str,expression)-1;
    trackname = str(1:idx_FINAL);
    ...
    if exist('bg_struct')
        save([trackname 'mod_' timenow '_FINAL.mat'],'TRACKS', 'EXIT_STRUCT', 'POKE_STRUCT','bg_struct');
    else
        save([trackname 'mod_' timenow '_nobgstruct_FINAL.mat'],'TRACKS', 'EXIT_STRUCT', 'POKE_STRUCT');
    end
end
